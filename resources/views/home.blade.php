                                            ...
                                            <div class="courses__item-content">
                                                <ul class="courses__item-meta list-wrap">
                                                    <li class="courses__item-tag">
                                                        <a href="course.html">{{ $val->kategori->nama_kategori }}</a>
                                                    </li>
                                                </ul>
                                                <h5 class="title"><a href="course-details.html">{{ $val->judul }}</a></h5>
                                                <p class="author">By <a href="#">{{ $val->mahasiswa->nama_lengkap}}</a></p>
                                                <div class="courses__item-bottom">
                                                    <div class="button">
                                                        <a href="/detail/{{ $val->media_id }}">
